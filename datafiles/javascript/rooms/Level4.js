...
export default class Level4 extends LevelRoom {
	constructor(g, returnRoom = undefined) {
		...
		for(let i = 0; i < 3; i++) {
			for(let j = 0; j < itemsInRow; j++) {
				...
				this.addBase(new Bubble(this.g, startMargin + j * planetDistance, 160 + i * planetDistance, newTeam, newSize, newUnits));
			}
		}
	}
}
